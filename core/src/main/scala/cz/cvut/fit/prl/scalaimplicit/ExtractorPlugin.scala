...
import cz.cvut.fit.prl.scalaimplicit.core.extractor.{CSV, ExtractImplicits, SingleProjectWalker}
import cz.cvut.fit.prl.scalaimplicit.core.extractor.Main.logger
import sbt._
import sbt.Keys._
