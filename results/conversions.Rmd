...
library(dplyr)
library(calibrate)
results_summary <- read_csv("~/work/scala/workshop/results/rawdata/conversion/results.callsite.summary.csv") %>% 
...
```{r}
project_metadata <- read_csv("~/work/scala/workshop/results/rawdata/project-metadata.csv")
```
